...
Public Class TaxApi
    ...
    Public Sub CreateEGSCodeUsage(codeType As String, parentCode As String, itemCode As String, codeName As String, codeNameAr As String, activeFrom As String, activeTo As String, description As String, descriptionAr As String, requestReason As String)
        Try
            Dim outgoingQueryString As NameValueCollection = HttpUtility.ParseQueryString(String.Empty)
            Dim json As String = "{""items"": [{""codeType"": """ & codeType & """,""parentCode"": """ & parentCode & """,""itemCode"": """ & itemCode & """,""codeName"": """ & codeName & """,""codeNameAr"": """ & codeNameAr & """,""activeFrom"": """ & activeFrom & """,""activeTo"": """ & activeTo & """,""description"": """ & description & """,""descriptionAr"": """ & descriptionAr & """,""requestReason"": """ & requestReason & """}]}"
            Dim serialize0 As String = Serialize(JsonConvert.DeserializeObject(json))
            ...
            ''outgoingQueryString.Add("""items""", " [{""codeType"": """ & codeType & """,""parentCode"": """ & parentCode & """,""itemCode"": """ & itemCode & """,""codeName"": """ & codeName & """,""codeNameAr"": """ & codeNameAr & """,""activeFrom"": """ & activeFrom & """}]")
            ...
            Dim result0 = JsonConvert.DeserializeObject(result)
            If result0("passedItemsCount") = 0 Then
                bm.ShowMSG(result0("failedItems")(0)("errors")(0).ToString)
            End If
        Catch ex As Exception
            'bm.ShowMSG(ex.Message)
        End Try
