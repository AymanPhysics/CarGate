...
Public Class HelpCases
    ...
    Private Sub btnSave_Click(sender As Object, e As RoutedEventArgs) Handles btnSave.Click
        ...
        If Not bm.AddItemToTable(tbl, {"Name", "EnName", "NationalId", "HomePhone", "Mobile", "Address", "AccNo"}, {txtArName.Text, txtEnName.Text, NationalId.Text, txtTel.Text, txtMob.Text, txtAddress.Text, StrAccNo}) Then Return
